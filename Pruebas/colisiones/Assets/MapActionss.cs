...
//     version 1.5.1
//     from Assets/MapActionss.inputactions
//
...
public partial class @MapActionss: IInputActionCollection2, IDisposable
{
    ...
    {
        private @MapActionss m_Wrapper;
        public MovementActions(@MapActionss wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MapActionss m_Wrapper;
        public GeneralActions(@MapActionss wrapper) { m_Wrapper = wrapper; }
